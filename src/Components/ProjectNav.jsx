...
const ProjectNav = ({skills, setSkills}) => {
  ...
  return (
    <div className="flex flex-col gap-7 fixed top-0 w-full rounded-bl-xl rounded-br-xl bg-[#010104] z-50 p-4">
       ...
       <div className="t2  flex items-center justify-center w-[60%] h-15 bg-[#080819] outline-0 px-5 text-[17px] rounded-2xl">  
           <FontAwesomeIcon icon={faMagnifyingGlass} className="text-gray-400 relative left-0"/>
           <input 
           value={Input}
           onChange={(e)=>setInput(e.target.value)}
          onKeyDown={handleKeyDown}
           className='w-full h-full bg-[#080819] outline-0 p-5 text-[17px] rounded-2xl' type="text" placeholder='Add skills like React, Python, NodeJS...' />
         </div>
