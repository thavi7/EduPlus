...
const projectCount = bookmarks.filter(b => b.type === "project").length
  return (
   <div className="students h-[30%] w-full flex justify-between items-center my-10 bg-[#080819] rounded-xl ">
        ...
        <div className="info flex flex-col justify-between items-start w-[40%] h-full ">
          ...
          <div className=" h-[40%] w-[80%] flex flex-col justify-between ">
            ...
            <div className='flex justify-between items-center py-2 '>
              <div className='bg-[#010104] px-5 py-1 rounded-xl    '>Python</div>
              <div className='bg-[#010104] px-5 py-1 rounded-xl    '>Java</div>
              <div className='bg-[#010104] px-5 py-1 rounded-xl    '>DSA</div>
              <div className='bg-[#010104] px-5 py-1 rounded-xl    '>AI</div>
            </div>
          </div>
        </div>
        <div className=" flex justify-evenly  items-center gap-2 w-[30%] h-full ">
          <div className=" h-[50%] w-30 bg-[#010104] rounded-2xl flex flex-col justify-evenly items-center p-2"><h1 className='text-3xl font-bold text-blue-500'>{courseCount}</h1><h1>COURSES</h1></div>
          <div className=" h-[50%] w-30 bg-[#010104] rounded-2xl flex flex-col justify-evenly items-center p-2"><h1 className='text-3xl font-bold text-blue-500'>{projectCount}</h1><h1>PROJECTS</h1></div> 
            </div>
      </div>
  )
}
